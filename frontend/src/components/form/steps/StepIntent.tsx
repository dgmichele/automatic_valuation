...
const INTENT_ICONS: Record<string, React.ElementType> = {
  'Voglio vendere casa in questo momento': BsLightningCharge,
  'Voglio vendere casa nei prossimi mesi': BsClockHistory,
  'Voglio vendere casa entro 1 anno': BsHourglassSplit,
