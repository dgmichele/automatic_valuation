...
const FormStepPage = () => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-start w-full max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="w-full max-w-2xl bg-brand-field/80 backdrop-blur-md rounded-2xl p-8 border border-brand-border mt-6" style={{ boxShadow: '0 4px 20px rgba(0, 0, 0, 0.05)' }}>
